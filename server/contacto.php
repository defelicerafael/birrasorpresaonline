...
$mensaje .= "Ya le avisamos a ".$array['amigo']." que tiene una BIRRA paga en nuestro BAR!<br/>";
$mensaje .= "Te vamos a avisar nuevamente cuando haya disfrutado de tu SORPRESA";
...
$mail->Subject = "Ya le avisamos a ".$array['amigo']." que tiene una BIRRA paga!"; // Este es el titulo del email.
